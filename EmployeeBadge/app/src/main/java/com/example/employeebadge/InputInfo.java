...
public class InputInfo extends AppCompatActivity implements PermissionRequest.Response{
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txtId.getText().toString()) || TextUtils.isEmpty(txtName.getText().toString()) || TextUtils.isEmpty(txtPosition.getText().toString())) {
                    Toast.makeText(InputInfo.this, "Vui lòng nhập đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                } else {
                    openCamera();
                }
            }
    ...
    private void sendData(Uri imageUri){
        Intent intent = new Intent(InputInfo.this, CropPictureCardActivity.class);
